...
public class DawUI {
    public static void main(String[] args) {
        // 입출금 계좌, 비밀번호 1111, 300000원을 보유하고 있는 테스트 계좌 생성
        User user = new User(true, "박현빈", 1111, 300000);
        ...
        while (otherService == 'Y') {
            ...
            if (service == 1) {
                ...
                // 비밀번호 일치
                    ...
                    // 기록
                    Record record = new Record(true, 1, amount);
            ...
            // 출금
                ...
                // !atm 감당가능 지폐인지 확인
                    ...
                    // 비밀번호 일치
                        ...
                        // 기록
                        Record record = new Record(true, 2, amount);
                        transaction.add(record);
                        // !기록
            ...
            // 계좌이체
                ...
                // 송금 수행
                    ...
                    // 비밀번호 일치
                        ...
                        // 기록
                        Record record = new Record(true, 3, amount);
                        transaction.add(record);
                        // !기록
